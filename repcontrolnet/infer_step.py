...
#                     reparams_path=repcontrolnet_model_path, subfolder="unet", alpha=alpha, beta=beta, stage="test").to(self.device)
...
#     output_folder = "output/repcontrolnet/step_exps/"
#     steps = [10000, 50000, 100000, 140000]
#     # infer
#     # betas = np.arange(0.0, 0.35, 0.05)
#     # alphas = np.arange(0.85, 1.2, 0.05)
#     alpha = 0.9
#     beta = 0.27
