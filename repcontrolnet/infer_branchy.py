...
# class RepControlNetInferBranch():
#     def __init__(self, repcontrolnet_model_path, base_model="stabilityai/stable-diffusion-2-1-base", 
...
#                     repcontrolnet=repcontrolnet_model_path, subfolder="unet", stage="train").to(self.device)
...
#     def __call__(self, prompt, cond_image, num_images_per_prompt=1, resolution=512):
#             images = self.inference(prompt, cond_image, num_images_per_prompt=num_images_per_prompt, resolution=resolution)
#             return images
# if __name__ == "__main__":
#     steps = [10000, 50000, 100000, 140000]
...
#     output_folder = "output/repcontrolnet/infer_branch/"
...
#     with torch.no_grad():
#         for step in steps:
#             repcontrolnet_model_path = f"/lustre/scratch/client/vinai/users/ngannh9/RepControlNet/code/output/rep_canny_3m/checkpoint-{step}/repcontrolnet_ema/repcontrolnet.pth"
#             infer = RepControlNetInferBranch(repcontrolnet_model_path)
#             images = infer(prompts, cond_images)
#             save_image(images, osp.join(output_folder, f"test_{step}.jpg"))
#             del infer
